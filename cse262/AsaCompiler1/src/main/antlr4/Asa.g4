...
grammar Asa ;
  ...
  ****************************/
  ...
  setLiteral
    : LBRACKET integerLiteral ( COMMA integerLiteral )* RBRACKET
    ;
  ...
  atype
    : IDENT # Ident
    | ARRAY LBRACKET integerLiteral DOTDOT integerLiteral RBRACKET OF atype # Array
    | SET /* OF integerLiteral DOTDOT integerLiteral */ # Set
    ;
