...
//-------------------------------------------------------------------------
/**
 * Defines operations on a deque (a double-ended queue). You can imagine a deque
 * as a sequence of items arranged in a line from left to right. We can call the
 * left end the "front" and the right end the "rear". Operations are provided to
 * insert or remove items from both ends.
 * <p>
 * In preconditions and postconditions, you will see see the following shorthand
 * used:
 * </p>
 * 
 * <pre>
